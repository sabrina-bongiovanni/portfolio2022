...
const ProjectItem = forwardRef((props, ref) => {
  ...
  const projScale = ['100%', '120%', '120%', '100%'];

  const SetScale = (scrollPositionArray) => {
  ...
  const imgName = projectsData.projectImg;

  return (
    <div className="project-item" key={projectsData.projectId} ref={projectRef}>
